#!/usr/bin/env python3
"""Build and validate Chromascope's unsigned Windows VST3 release artifact."""
...
SAFE_ARCHIVE_NAME = re.compile(
    r"^chromascope-v[0-9A-Za-z.-]+-windows-x86_64-unsigned\.vst3\.zip$"
)
...
def bundle_name(package_version: str) -> str:
    return f"Chromascope-v{package_version}.vst3"


def archive_name(publication_version: str) -> str:
    return f"chromascope-v{publication_version}-windows-x86_64-unsigned.vst3.zip"
